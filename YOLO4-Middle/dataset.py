# Transfer numpy to tensorflow operations
import os
import cv2
import random
import numpy as np
...
from configs import *
from yolov4_f import bbox_iou, read_class_names
...
class Dataset(object):
    ...
    def __next__(self):
        with tf.device('/cpu:0'):
            ...
            batch_image = np.zeros((self.batch_size, self.train_input_size, self.train_input_size, self.dims),
                                   dtype=np.float32)
